...
Save isDarkMode to localStorage so it survives page refresh (update AppContext.tsx).
</todo>

<todo>
Add product management UI
Allow adding/editing/deleting products from the POS interface (new modal + context actions).
</todo>

<todo>
Clear manual total option
Add a "Reset" button in the manual tab when manualTotal is already set, to revert to weight-based calculation.
</todo>
